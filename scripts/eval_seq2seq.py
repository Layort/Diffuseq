...
print('nltk import before')
import nltk
nltk.download('punkt')
# print(nltk.word_tokenize("dsd deca ds"))
# pdb.set_trace()
print('nltk import after')
...
'''
cd scripts
python eval_seq2seq.py --folder "../generation_outputs/diffuseq_qqp_h128_lr0.0001_t2000_sqrt_lossaware_seed102_test-qqp20230114-23:10:02/ema_0.9999_010000.pt.samples" --mbr
'''