...
from diffuseq.text_datasets_raw import load_data_text
...
def create_argparser():
    #定义了字典，数据目录，学习率一些默认的超参数,dict会更新,其返回也是一个字典，但是其键值对和模型和扩散相关的参数
    #创建argumentParser，遍历字典添加到argparser中，这样省的我们一个个去写手写add_argument，
    defaults = dict()
    defaults.update(load_defaults_config()) #basic_util.py Load defaults for training args
